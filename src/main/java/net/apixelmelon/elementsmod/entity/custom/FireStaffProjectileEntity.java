...
public class FireStaffProjectileEntity extends Projectile {
    private static final EntityDataAccessor<Boolean> HIT =
            SynchedEntityData.defineId(FireStaffProjectileEntity.class, EntityDataSerializers.BOOLEAN);
    private int counter = 0;

    public FireStaffProjectileEntity(EntityType<? extends Projectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public FireStaffProjectileEntity(Level pLevel, Player player) {
        super(ModEntities.FIRE_STAFF_PROJECTILE.get(), pLevel);
        setOwner(player);
