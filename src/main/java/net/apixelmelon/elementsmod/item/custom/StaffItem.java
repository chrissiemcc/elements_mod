...
public class StaffItem extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        if(!pLevel.isClientSide()) {
            StaffProjectileEntity staffProjectile = new StaffProjectileEntity(pLevel, pPlayer);
            staffProjectile.shootFromRotation(pPlayer, pPlayer.getXRot(), pPlayer.getYRot(), 0.0F, 1.5F, 0.25F);
            pLevel.addFreshEntity(staffProjectile);
        }
